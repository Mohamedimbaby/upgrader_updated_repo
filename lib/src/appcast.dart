      ...
      document.findAllElements('item').forEach((XmlElement itemElement) {
        ...
        itemElement.children.forEach((XmlNode childNode) {
          if (childNode is XmlElement) {
            ...
            }  else if (name == AppcastConstants.ElementMinimumAppVersion) {
              minimumAppVersion = childNode.text;
...
class AppcastConstants {
  ...
  static const String ElementMinimumAppVersion =
      'sparkle:minAppVersion';
